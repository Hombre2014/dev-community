class WorkExperiencesController < ApplicationController
  ...
  def create
    ...
    if @work_experience.save
      render_turbo_stream('append', 'work-experiences', 'work_experiences/work_experience', { work_experience: @work_experience })
    else
      render_turbo_stream('replace', 'remote_modal', 'shared/turbo_modal', { form_partial: 'work_experiences/form', modal_title: 'Add work experience'})
    end
  end
